 ...
 * 
 */
@WebServiceClient(name = "BusinessLogicService", targetNamespace = "http://soap.server.integration/", wsdlLocation = "http://localhost:8080/introsde/integration/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSLOGICSERVICE_QNAME = new QName("http://soap.server.integration/", "BusinessLogicService");
    ...
    public EndpointInterface getEndpointPort() {
        return super.getPort(new QName("http://soap.server.integration/", "EndpointPort"), EndpointInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "EndpointPort")
    public EndpointInterface getEndpointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.server.integration/", "EndpointPort"), EndpointInterface.class, features);
    }
