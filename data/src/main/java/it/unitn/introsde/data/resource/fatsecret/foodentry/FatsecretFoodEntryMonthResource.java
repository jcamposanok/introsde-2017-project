package it.unitn.introsde.data.resource.fatsecret.foodentry;

import it.unitn.introsde.data.oauth.FatsecretAuthService;
import it.unitn.introsde.data.resource.FatsecretResource;
